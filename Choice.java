...
public class Choice {
    ...
    public static void choiceOne(Scanner sc) throws IOException{
        ...
        if(base>10){
            ...
            //declare file - got this line of code with the help of stackoverflow as I couldn't determine how to route it https://stackoverflow.com/questions/6853877/reading-a-file-from-current-directory-in-java
            File file = new File(System.getProperty("user.dir") + "/ASCII.txt");
